...
u32 AHB9_Read(struct Console* sys, timestamp* ts, u32 addr, const u32 mask, const bool atomic, const bool hold, bool* seq)
{
    ...
    {
    case 0x02: // Main RAM
        LogPrint(LOG_UNIMP|LOG_ARM9, "NTR_AHB9: Unimplemented READ%i: MAINRAM\n", width);
        ret = Bus_MainRAM_Read(sys, &sys->AHB9, timestamp_max/*ah shit*/, addr, mask, atomic, hold, seq);
        break;

    case 0x03: // Shared WRAM
        LogPrint(LOG_UNIMP|LOG_ARM9, "NTR_AHB9: Unimplemented READ%i: SWRAM\n", width);
    ...
    case 0x04: // Memory Mapped IO
        LogPrint(LOG_UNIMP|LOG_ARM9, "NTR_AHB9: Unimplemented READ%i: IO\n", width);
    ...
    case 0x05: // 2D GPU Palette
        LogPrint(LOG_UNIMP|LOG_ARM9, "NTR_AHB9: Unimplemented READ%i: PALETTE\n", width);
